package by.bsuir.lab02.synchronize.logic.client;


import by.bsuir.lab02.synchronize.logic.callcenter.CallCenter;
import by.bsuir.lab02.synchronize.logic.callcenter.Operator;
...
public class Client extends Thread {
    ...
    public Client(String clientName, CallCenter callCenter) {
        ...
        this.patienceTime = new Random().nextInt(1000) + 2000;
    }
